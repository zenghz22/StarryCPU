...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_15 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_15 xil_defaultlib)
