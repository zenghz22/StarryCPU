...
#
# Script generated by Vivado on Fri Jul 12 19:03:54 +0800 2024
...
# script info
echo -e "inst_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_ram xil_defaultlib.inst_ram xil_defaultlib.glbl -log elaborate.log
}
