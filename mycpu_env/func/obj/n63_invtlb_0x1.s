...
# 6 "../include/asm.h" 2
# 2 "n63_invtlb_0x1.S" 2
# 1 "../include/regdef.h" 1
# 3 "n63_invtlb_0x1.S" 2
...
# 4 "n63_invtlb_0x1.S" 2

.text; .globl n63_invtlb_0x1_test; .align 3; .cfi_startproc ; .type n63_invtlb_0x1_test, @function; n63_invtlb_0x1_test:
    addi.w $r23, $r23, 0x1
    addi.w $r25, $r0, 0x0
...
inst_error:
    ...
    st.w $r12, $r24, 0x0
    jirl $r0, $r1, 0x0
.cfi_endproc ; .size n63_invtlb_0x1_test,.-n63_invtlb_0x1_test;
