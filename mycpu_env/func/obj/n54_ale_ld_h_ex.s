...
# 6 "../include/asm.h" 2
# 2 "n54_ale_ld_h_ex.S" 2
# 1 "../include/regdef.h" 1
# 3 "n54_ale_ld_h_ex.S" 2
...
# 4 "n54_ale_ld_h_ex.S" 2

.text; .globl n54_ale_ld_h_ex_test; .align 3; .cfi_startproc ; .type n54_ale_ld_h_ex_test, @function; n54_ale_ld_h_ex_test:

  addi.w $r23, $r23, 1
  li.w $r16, 0x36
  li.w $r12, 0x1d0000; li.w $r25, 0x6; st.w $r25, $r12, 0
...
1:
  ...
  li.w $r12, 0x1d0000; li.w $r25, 0xf; st.w $r25, $r12, 0
  syscall 0
  csrrd $r12, 0x7
...
inst_error:
  ...
  st.w $r12, $r24, 0
  jirl $r0, $r1, 0
.cfi_endproc ; .size n54_ale_ld_h_ex_test,.-n54_ale_ld_h_ex_test;
