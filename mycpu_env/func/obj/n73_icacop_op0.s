...
# 6 "../include/asm.h" 2
# 2 "n73_icacop_op0.S" 2
# 1 "../include/regdef.h" 1
# 3 "n73_icacop_op0.S" 2
...
# 4 "n73_icacop_op0.S" 2

.text; .globl n73_icacop_op0; .align 3; .cfi_startproc ; .type n73_icacop_op0, @function; n73_icacop_op0:
    addi.w $r23, $r23, 0x1
    add.w $r25, $r0, $r0
...
inst_error:
    ...
    st.w $r12, $r24, 0x0
    jirl $r0, $r1, 0x0
.cfi_endproc ; .size n73_icacop_op0,.-n73_icacop_op0;
